...
- **Excel Report Download** — Full present/absent report for all students; supports filtering by method (face / qr / manual / all)
- **Multi-Session Reports** — Report covers all attendance methods used in the same page session
...
└── frontend/
    └── src/
        ...
        │   ├── Home.jsx          # Faculty dashboard (face, QR, manual, report)
...
5. Cosine similarity ≥ 0.50 → matched; else → Unknown
...
5. Added students appear in a persistent panel on the dashboard
...
3. Filter by method: All / Face / QR / Manual
4. Excel file is colour-coded: green = Present, red = Absent
